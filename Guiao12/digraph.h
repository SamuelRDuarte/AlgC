...
/*******************************************************************************
 Determina a classifica��o (entre 0.0 e 1.0) de um dado v�rtice de acordo com o seu
 grau (soma do n�mero de antecessores e de sucessores diretos).
...
/*******************************************************************************
 ...
 criado ou NULL, no caso de inexist�ncia de mem�ria ou do d�grafo pdig.
...
/*******************************************************************************
 Cria o d�grafo transposto do d�grafo pdig. Devolve a refer�ncia do d�grafo 
 criado ou NULL, no caso de inexist�ncia de mem�ria ou do d�grafo pdig.
...
/*******************************************************************************
 Subdivide uma dada aresta substituindo-a por um v�rtice e duas arestas adicionais.
 O identificador do v�rtice ser� o pr�ximo �ndice que se possa utilizar. O custo
 de cada aresta ser� metade do custo da aresta original. A primeira aresta deve ter
...
/*******************************************************************************
 Cinde um dado v�rtice substituindo-o por dois v�rtices ligados por uma aresta de
 custo zero. Os identificadores dos novos v�rtices ser�o os pr�ximos �ndices que
 se possa utilizar. Os predecessores do v�rtice original s�o agora os predecessores
 do primeiro v�rtice acrescentado, e os sucessores s�o sucessores do segundo v�rtice
...
/*******************************************************************************
 Cria uma fila contendo os v�rtices que s�o sucessores diretos de um dado v�rtice
 e cuja dist�ncia a esse v�rtice � inferior a pdst. A fun��o cria uma fila de
 inteiros contendo a identifica��o dos v�rtices e devolve a refer�ncia da fila em
 pqueue ou NULL caso n�o haja mem�ria para criar e preencher a fila.
...
/*******************************************************************************
 Cria uma fila com os pares de v�rtices (v�rtice emergente seguido do v�rtice 
 incidente) que definem as arestas incidentes num dado v�rtice. A fun��o cria uma
 fila de pares de inteiros contendo a identifica��o das arestas e devolve a refer�ncia
 da fila em pqueue ou NULL caso n�o haja mem�ria para criar e preencher a fila.
